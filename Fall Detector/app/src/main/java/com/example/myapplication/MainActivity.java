    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dataInstance = new DataInstance(getApplicationContext(),predict,sensorManager,accelerometerSensorListener,gyroscopicSensorListener,orientationSensorListener);
