...
public class DataInstance {
    ...
    public DataInstance(Context context, TextView predict, SensorManager sensorManager, SensorEventListener accelerometer, SensorEventListener gyroscopic, SensorEventListener orientation){
