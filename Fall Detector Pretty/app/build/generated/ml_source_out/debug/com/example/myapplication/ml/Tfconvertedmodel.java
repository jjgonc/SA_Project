...
public final class Tfconvertedmodel {
  @NonNull
  private final Model model;

  private Tfconvertedmodel(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "tfconvertedmodel.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Tfconvertedmodel newInstance(@NonNull Context context) throws IOException {
    return new Tfconvertedmodel(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Tfconvertedmodel newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new Tfconvertedmodel(context, options);
  }
